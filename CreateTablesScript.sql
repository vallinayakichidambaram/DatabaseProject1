...
(
  SUB_CAT_NO INT PRIMARY KEY,
  SUB_CAT_NAME VARCHAR(255) NOT NULL,
  MAIN_CAT_NO INT NOT NULL,
...
(
  ...
  SUPPLIER_PINCODE INT(6) NOT NULL,
...
(
  ...
  PAYMENT_REFERENCE INT (35) NOT NULL,
...
(
  ORDER_RELATION_NO	INT PRIMARY KEY,
  ORDER_ID INT NOT NULL,
  PRODUCT_NO INT NOT NULL,
  SUPPLIER_ID IN NOT NULL,
  EXPECTED_DELIVERY DATE NOT NULL,
